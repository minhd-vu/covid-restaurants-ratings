  ...
  $.fn.googlePlaces = function (options) {
    ...
    var renderReviews = function (reviews) {
      ...
      for (var i = rowCount; i >= 0; i--) {
        ...
        html = html + "<div class=" + style + "><div class='review-header'>" + picture + "<div class='review-usergrade'><div class='review-meta'><span class='review-author'>" + name + "</span><span class='review-sep'></span>"+"<br><span class='review-date'>"+date+"</span>" + "</div>" + stars + "</div></div><p class='review-text'>" + reviewText + "</p></div>";
